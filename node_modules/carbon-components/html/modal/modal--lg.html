...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t368jark5md">Show
  modal</button>

<div data-modal id="modal-t368jark5md" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t368jark5md-label" aria-describedby="modal-t368jark5md-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t368jark5md-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t368jark5md-heading">Modal heading</p>
