...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-n2u92gbg3h">Show
  modal</button>

<div data-modal id="modal-n2u92gbg3h" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-n2u92gbg3h-label" aria-describedby="modal-n2u92gbg3h-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n2u92gbg3h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n2u92gbg3h-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
