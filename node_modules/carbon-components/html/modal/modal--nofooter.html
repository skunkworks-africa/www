...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0zi5ndwve6vk">Show
  modal</button>

<div data-modal id="modal-0zi5ndwve6vk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0zi5ndwve6vk-label" aria-describedby="modal-0zi5ndwve6vk-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0zi5ndwve6vk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0zi5ndwve6vk-heading">Modal heading</p>
