...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1nayq9u7kux">Show
  modal</button>

<div data-modal id="modal-1nayq9u7kux" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1nayq9u7kux-label" aria-describedby="modal-1nayq9u7kux-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1nayq9u7kux-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1nayq9u7kux-heading">Modal heading</p>
