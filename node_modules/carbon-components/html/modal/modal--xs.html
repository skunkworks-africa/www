...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i7dxdbeynkq">Show
  modal</button>

<div data-modal id="modal-i7dxdbeynkq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i7dxdbeynkq-label" aria-describedby="modal-i7dxdbeynkq-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i7dxdbeynkq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i7dxdbeynkq-heading">Modal heading</p>
