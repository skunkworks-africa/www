...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-m87bchc237q">Show
  modal</button>

<div data-modal id="modal-m87bchc237q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-m87bchc237q-label" aria-describedby="modal-m87bchc237q-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-m87bchc237q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-m87bchc237q-heading">Modal heading</p>
