...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zjkmpqoel3d">Show
  modal</button>

<div data-modal id="modal-zjkmpqoel3d" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zjkmpqoel3d-label" aria-describedby="modal-zjkmpqoel3d-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zjkmpqoel3d-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zjkmpqoel3d-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-zjkmpqoel3d" class="bx--label">Text Input label</label>
        <input id="text-input-zjkmpqoel3d" type="text" class="bx--text-input" placeholder="Optional placeholder text"
