...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qhdx604cbt">Show
  modal</button>

<div data-modal id="modal-qhdx604cbt" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qhdx604cbt-label" aria-describedby="modal-qhdx604cbt-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qhdx604cbt-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qhdx604cbt-heading">Modal heading</p>
