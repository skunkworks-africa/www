...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dr1393mtrqt">Show
  modal</button>

<div data-modal id="modal-dr1393mtrqt" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dr1393mtrqt-label" aria-describedby="modal-dr1393mtrqt-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dr1393mtrqt-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dr1393mtrqt-heading">Modal heading</p>
