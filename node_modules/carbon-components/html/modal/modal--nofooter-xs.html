...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ss4xcryd3md">Show
  modal</button>

<div data-modal id="modal-ss4xcryd3md" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ss4xcryd3md-label" aria-describedby="modal-ss4xcryd3md-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ss4xcryd3md-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ss4xcryd3md-heading">Modal heading</p>
