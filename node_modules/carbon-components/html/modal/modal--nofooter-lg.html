...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uxtjm4tj4w7">Show
  modal</button>

<div data-modal id="modal-uxtjm4tj4w7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uxtjm4tj4w7-label" aria-describedby="modal-uxtjm4tj4w7-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uxtjm4tj4w7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uxtjm4tj4w7-heading">Modal heading</p>
